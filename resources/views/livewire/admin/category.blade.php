...
<div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800 font-weight-bold">Categories</h1>
        <button class="btn btn-primary" data-toggle="modal" data-target="#createCategory">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Sports</td>
                                    <td class="text-right">
                                        <button class="btn btn-light btn-sm" data-toggle="modal" data-target="#updateCategory">
